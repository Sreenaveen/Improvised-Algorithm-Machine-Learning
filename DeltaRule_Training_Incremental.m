function [w, out, e,counter]=DeltaRule_Training_Incremental(data, class, eta, iterations)
...
if row_q1 ~= row_class
    ...
    for j = 1: iterations
        ...
        for i = 1 : row_q1
            ...
            w(2,1) = w(2,1) + delta_w(2,1);
            w(3,1) = w(3,1) + delta_w(3,1);
